...
ParticleSource::ParticleSource(float position[3], float color[4], Physics::Buckets *buckets, std::shared_ptr<Graphics::Base::Scene> *scene, float mass_per_time, float velocity[3])
:
...
ParticleSource::ParticleSource(float position[3], float color[4], Physics::Buckets *buckets, std::shared_ptr<Graphics::Base::Scene> *scene, float mass_per_time, float velocity[3], int max)
:
    d_mass_per_time(mass_per_time),
    d_scene(scene),
    d_buckets(buckets),
